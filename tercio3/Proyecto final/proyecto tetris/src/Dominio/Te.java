        ...
        for (int i = 19; i >= 0; i -= 1) {
            for (int j = 9; j >= 0; j -= 1) {
                if (tablero[19][j] == 4 && bandera) {
                    ...
                    } else if (tablero[i][j] == 4 && tablero[i-1][j] == 4 && i < 19 && (tablero[i + 1][j] != -2)) {
                        bandera = false;
                        tablero[i - 1][j] = 0;
                        tablero[i - 1][j - 1] = 0;
                        tablero[i - 1][j + 1] = 0;
        ...
        for (int i = 19; i >= 0; i -= 1) {
            for (int j = 9; j >= 0; j -= 1) {
                if(tablero[i][j] == 4  && i < 19){
                    ...
                    else if(currentflag == 2 && j > 1 && i>1) {
                        if (tablero[i][j - 1] == 6 || tablero[i - 1][j -2] == 6 || tablero[i - 2][j - 1] == 6 || tablero[i][j - 1] == 7 || tablero[i - 1][j - 2] == 7 || tablero[i - 2][j - 1] == 7 || tablero[i][j - 1] == 8 || tablero[i - 1][j - 2] == 8 || tablero[i - 2][j - 1] == 8 || tablero[i][j - 1] == 9 || tablero[i - 1][j - 2] == 9 || tablero[i - 2][j - 1] == 9) {
                            bufocapturado();
                        }
                    }
                    else if(currentflag == 3 && j > 2 && i>0) {
    ...
    public int[][] nextState(){
        ...
        for(int i=0; i<20; i++){
            for(int j=0; j<10; j++){
                ...
                }else if (tablero[i][j] == 4 && currentflag == 4 && flag && j > 1){
                    currentflag = 1;
